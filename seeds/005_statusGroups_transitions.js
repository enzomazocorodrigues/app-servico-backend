  ...
  return knex('statusGroups_transitions').del()
    .then(function () {
      ...
      return knex('statusGroups_transitions').insert([
        ...
        { idParent: 2, order: 1, idStatusFrom: 0, idStatusTo: 11, default: true },
        { idParent: 2, order: 2, idStatusFrom: 11, idStatusTo: 0, default: true },
        { idParent: 2, order: 3, idStatusFrom: 11, idStatusTo: 12, default: true },
        { idParent: 2, order: 4, idStatusFrom: 12, idStatusTo: 13, default: true },
        { idParent: 2, order: 5, idStatusFrom: 13, idStatusTo: 12, default: true }
      ]);
    });
};
