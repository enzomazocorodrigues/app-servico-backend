  ...
  return knex('tables').del()
    .then(function () 
    {
      ...
      return knex('tables').insert([
        ...
        { id: 6, idStatus: 2, name: "people", alias: "peo", order: 1, idStatusGroup: 2, description: "nome", },
        ...
        { id: 19, idStatus: 2, name: "products", alias: "prod", order: 1, idStatusGroup: 3, description: "descricao" },
        { id: 20, idStatus: 2, name: "products_categories", alias: "prod", order: 2, idStatusGroup: null, description: "descricao", key: "idParent" },
        { id: 21, idStatus: 2, name: "orders", alias: "ord", order: 1, idStatusGroup: 4, description: null },
        { id: 22, idStatus: 2, name: "orders_items", alias: "ord_ite", order: 2, idStatusGroup: null, description: null, key: "idParent" },
        { id: 23, idStatus: 2, name: "transaction", alias: "tran", order: 1, idStatusGroup: 5, description: null }
      ])
    });
};
